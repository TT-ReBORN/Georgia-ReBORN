...
let bioProperties = [
	...
	['Panel Biography - Lyrics: Scroll easing', 'easeOutQuad', 'lyricsScrollEasing'],
	['Panel Biography - Lyrics: Show drop shadow', 'normal', 'lyricsDropShadowLevel'],
	['Panel Biography - Lyrics: Show fade scroll', true, 'lyricsFadeScroll'],
	['Panel Biography - Lyrics: Show transparent mask', 0, 'lyricsTransparentMask'],
	['Panel Biography - Lyrics: Show larger current sync', true, 'lyricsLargerCurrentSync'],
	['Panel Biography - Lyrics: Line spacing', 24, 'lyricsLineSpacing'],
	['Panel Biography - Lyrics: Sentence spacing', 14, 'lyricsSentenceSpacing'],
	['Panel Biography - Lyrics: Scroll speed', 'normal', 'lyricsScrollSpeed'],
	['Panel Biography - Lyrics: Adaptive scroll speed', true, 'lyricsScrollAdaptive'],
