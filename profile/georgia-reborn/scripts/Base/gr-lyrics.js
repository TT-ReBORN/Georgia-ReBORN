...
class Lyrics {
	...
	repaintRect() {
		if (pref.lyricsFadeScroll) window.RepaintRect(this.x, this.y, this.w, this.h);
		if (!pref.lyricsFadeScroll || this.showOffset) window.RepaintRect(this.x, this.y, this.w, this.h);
	}
