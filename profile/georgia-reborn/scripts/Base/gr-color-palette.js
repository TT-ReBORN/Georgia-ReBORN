...
class ColorPalette {
	...
	initCustomThemeColors() {
		...
		return {
			...
			lib_ex_col_column_bg: HEXtoRGB(c.lib_ex_col_column_bg),
			lib_ex_col_column_line: HEXtoRGB(c.lib_ex_col_column_line),
			lib_ex_col_column_text_normal: HEXtoRGB(c.lib_ex_col_column_text_normal),
			lib_ex_col_column_text_hovered: HEXtoRGB(c.lib_ex_col_column_text_hovered),
			lib_ex_col_column_text_playing: HEXtoRGB(c.lib_ex_col_column_text_playing),
			lib_ex_col_column_text_selected: HEXtoRGB(c.lib_ex_col_column_text_selected),
			lib_ex_col_grid_playing_bg: HEXtoRGB(c.lib_ex_col_grid_playing_bg),
			lib_ex_col_grid_selection_bg: HEXtoRGB(c.lib_ex_col_grid_selection_bg),
			lib_ex_col_grid_selection_frame: HEXtoRGB(c.lib_ex_col_grid_selection_frame),
			lib_ex_col_grid_sideMarker: HEXtoRGB(c.lib_ex_col_grid_sideMarker),
			lib_ex_col_grid_title_normal: HEXtoRGB(c.lib_ex_col_grid_title_normal),
			lib_ex_col_grid_title_hovered: HEXtoRGB(c.lib_ex_col_grid_title_hovered),
			lib_ex_col_grid_title_playing: HEXtoRGB(c.lib_ex_col_grid_title_playing),
			lib_ex_col_grid_title_selected: HEXtoRGB(c.lib_ex_col_grid_title_selected),
			lib_ex_col_row_stripes_bg: HEXtoRGB(c.lib_ex_col_row_stripes_bg),
			lib_ex_col_row_playing_bg: HEXtoRGB(c.lib_ex_col_row_playing_bg),
			lib_ex_col_row_selection_bg: HEXtoRGB(c.lib_ex_col_row_selection_bg),
			lib_ex_col_row_selection_frame: HEXtoRGB(c.lib_ex_col_row_selection_frame),
			lib_ex_col_row_sideMarker: HEXtoRGB(c.lib_ex_col_row_sideMarker),
			lib_ex_col_row_title_normal: HEXtoRGB(c.lib_ex_col_row_title_normal),
			lib_ex_col_row_title_hovered: HEXtoRGB(c.lib_ex_col_row_title_hovered),
			lib_ex_col_row_title_playing: HEXtoRGB(c.lib_ex_col_row_title_playing),
			lib_ex_col_row_title_selected: HEXtoRGB(c.lib_ex_col_row_title_selected),
			lib_ex_col_rating_star: HEXtoRGB(c.lib_ex_col_rating_star),
			lib_ex_col_rating_star_shadow: RGBA(0, 0, 0, 100),
			lib_ex_col_sbar_normal: HEXtoRGB(c.lib_ex_col_sbar_normal),
			lib_ex_col_sbar_hovered: HEXtoRGB(c.lib_ex_col_sbar_hovered),
			lib_ex_col_sbar_drag: HEXtoRGB(c.lib_ex_col_sbar_drag),
			lib_ex_col_closeBtn: HEXtoRGB(c.lib_ex_col_closeBtn),
			lib_ex_col_closeBtn_bg: HEXtoRGB(c.lib_ex_col_closeBtn_bg),
			// #endregion
	...
	setCurrentColorsToCustomTheme(slot) {
		const currentColors = {
			...
			// * LIBRARY EXPLORER COLORS * //
			lib_ex_col_column_bg: RGBFtoHEX(lib.ex.color.column_bg),
			lib_ex_col_column_line: RGBFtoHEX(lib.ex.color.column_line),
			lib_ex_col_column_text_normal: RGBFtoHEX(lib.ex.color.column_text_normal),
			lib_ex_col_column_text_hovered: RGBFtoHEX(lib.ex.color.column_text_hovered),
			lib_ex_col_column_text_playing: RGBFtoHEX(lib.ex.color.column_text_playing),
			lib_ex_col_column_text_selected: RGBFtoHEX(lib.ex.color.column_text_selected),
			lib_ex_col_grid_playing_bg: RGBFtoHEX(lib.ex.color.grid_playing_bg),
			lib_ex_col_grid_selection_bg: RGBFtoHEX(lib.ex.color.grid_selection_bg),
			lib_ex_col_grid_selection_frame: RGBFtoHEX(lib.ex.color.grid_selection_frame),
			lib_ex_col_grid_sideMarker: RGBFtoHEX(lib.ex.color.grid_sideMarker),
			lib_ex_col_grid_title_normal: RGBFtoHEX(lib.ex.color.grid_title_normal),
			lib_ex_col_grid_title_hovered: RGBFtoHEX(lib.ex.color.grid_title_hovered),
			lib_ex_col_grid_title_playing: RGBFtoHEX(lib.ex.color.grid_title_playing),
			lib_ex_col_grid_title_selected: RGBFtoHEX(lib.ex.color.grid_title_selected),
			lib_ex_col_row_stripes_bg: RGBFtoHEX(lib.ex.color.row_stripes_bg),
			lib_ex_col_row_playing_bg: RGBFtoHEX(lib.ex.color.row_playing_bg),
			lib_ex_col_row_selection_bg: RGBFtoHEX(lib.ex.color.row_selection_bg),
			lib_ex_col_row_selection_frame: RGBFtoHEX(lib.ex.color.row_selection_frame),
			lib_ex_col_row_sideMarker: RGBFtoHEX(lib.ex.color.row_sideMarker),
			lib_ex_col_row_title_normal: RGBFtoHEX(lib.ex.color.row_title_normal),
			lib_ex_col_row_title_hovered: RGBFtoHEX(lib.ex.color.row_title_hovered),
			lib_ex_col_row_title_playing: RGBFtoHEX(lib.ex.color.row_title_playing),
			lib_ex_col_row_title_selected: RGBFtoHEX(lib.ex.color.row_title_selected),
			lib_ex_col_rating_star: RGBFtoHEX(lib.ex.color.rating_star),
			lib_ex_col_rating_star_shadow: RGBFtoHEX(lib.ex.color.rating_star_shadow),
			lib_ex_col_sbar_normal: RGBFtoHEX(lib.ex.color.sbar_normal),
			lib_ex_col_sbar_hovered: RGBFtoHEX(lib.ex.color.sbar_hovered),
			lib_ex_col_sbar_drag: RGBFtoHEX(lib.ex.color.sbar_drag),
			lib_ex_col_closeBtn: RGBFtoHEX(lib.ex.color.closeBtn),
			lib_ex_col_closeBtn_bg: RGBFtoHEX(lib.ex.color.closeBtn_bg),
