...
function drawStyles(gr) {
	if (pref.styleBevel) {
		...
		if ((pref.layout === 'default' && (displayPlaylist || displayLibrary) && !displayBiography ||
			...
			gr.FillSolidRect(albumArtSize.x - 1, geo.topMenuHeight, pref.layout === 'default' ? albumArtSize.w + 1 : ww + 1, (displayLibrary && pref.libraryLayout === 'full' ? 0 : albumArtSize.y) - geo.topMenuHeight - 1, RGBtoRGBA(col.styleBevel, 40));
		}
