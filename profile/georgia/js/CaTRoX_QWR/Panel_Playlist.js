...
function initPlaylistColors() {
	if (pref.whiteTheme) {
		...
		//---> Common
		g_pl_colors.background = RGB(255, 255, 255);
		//---> Playlist Manager
		if (pref.autoHidePLM === true) {
		g_pl_colors.playlist_mgr_text_normal = g_pl_colors.background;
		g_pl_colors.playlist_mgr_text_hovered = RGB(120, 120, 120);
		g_pl_colors.playlist_mgr_text_pressed = RGB(80, 80, 80);
		} else {
		g_pl_colors.playlist_mgr_text_normal = RGB(140, 140, 140);
		g_pl_colors.playlist_mgr_text_hovered = RGB(80, 80, 80);
		g_pl_colors.playlist_mgr_text_pressed = RGB(140, 140, 140);
		}
		//---> Header
		g_pl_colors.group_title = RGB(120, 120, 120);
		g_pl_colors.group_title_selected = g_pl_colors.group_title;
		g_pl_colors.artist_normal = g_pl_colors.group_title;
		g_pl_colors.artist_playing = RGB(120, 120, 120);
		g_pl_colors.album_normal = RGB(120, 120, 120);
		g_pl_colors.album_playing = RGB(120, 120, 120);
		g_pl_colors.info_normal = RGB(120, 120, 120);
		g_pl_colors.info_playing = g_pl_colors.info_normal;
		g_pl_colors.date_normal = RGB(120, 120, 120);
		g_pl_colors.date_playing = g_pl_colors.date_normal;
		g_pl_colors.line_normal = RGB(200, 200, 200);
		g_pl_colors.line_playing = RGB(200, 200, 200);
		g_pl_colors.line_selected = RGB(200, 200, 200);
		//---> Row
		g_pl_colors.title_selected = RGB(0, 0, 0);
		g_pl_colors.title_playing = RGB(245, 245, 245);
		g_pl_colors.title_normal = RGB(100, 100, 100);
		...
		g_theme.colors.pss_back = RGB(255, 255, 255);
		g_theme.colors.panel_back = RGB(255, 255, 255);
		g_theme.colors.panel_front = RGB(255, 255, 255);
		g_theme.colors.panel_line = RGB(200, 200, 200);
		g_theme.colors.panel_line_selected = RGB(200, 200, 200);
		g_theme.colors.panel_text_normal = RGB(120, 120, 120);
		...
		//---> Header
		g_pl_colors.group_title = RGB(120, 120, 120);
		g_pl_colors.group_title_selected = RGB(255, 255, 255);
		g_pl_colors.artist_normal = g_pl_colors.group_title;
		g_pl_colors.artist_playing = RGB(255, 255, 255);
		g_pl_colors.album_normal = RGB(120, 120, 120);
		g_pl_colors.album_playing = RGB(255, 255, 255);
		g_pl_colors.info_normal = RGB(120, 120, 120);
		g_pl_colors.info_playing = RGB(255, 255, 255);
		g_pl_colors.date_normal = RGB(120, 120, 120);
		g_pl_colors.date_playing = RGB(255, 255, 255);
		g_pl_colors.line_normal = RGB(200, 200, 200);
		g_pl_colors.line_playing = RGB(200, 200, 200);
		g_pl_colors.line_selected = RGB(200, 200, 200);
		//---> Row
		g_pl_colors.title_selected = RGB(0, 0, 0);
		g_pl_colors.title_playing = RGB(245, 245, 245);
		g_pl_colors.title_normal = RGB(120, 120, 120);
		g_pl_colors.rating_color = RGB(255, 190, 0);
		...
		if (pref.autoHidePLM === true) {
		g_pl_colors.playlist_mgr_text_normal = g_pl_colors.background;
		g_pl_colors.playlist_mgr_text_hovered = RGB(200, 200, 200);
		g_pl_colors.playlist_mgr_text_pressed = RGB(240, 240, 240);
		} else {
		g_pl_colors.playlist_mgr_text_normal = RGB(180, 180, 180);
		g_pl_colors.playlist_mgr_text_hovered = RGB(240, 240, 240);
		g_pl_colors.playlist_mgr_text_pressed = RGB(180, 160, 180);
		}
		//---> Header
		...
		g_pl_colors.album_playing = RGB(245, 245, 245);
		g_pl_colors.info_normal = RGB(200, 200, 200);
		g_pl_colors.info_playing = RGB(245, 245, 245);
		g_pl_colors.date_normal = RGB(220, 220, 220);
		g_pl_colors.date_playing = RGB(245, 245, 245);
		g_pl_colors.line_normal = RGB(45, 45, 45);
		g_pl_colors.line_playing = RGB(25, 25, 25);
		g_pl_colors.line_selected = RGB(25, 25, 25);
		//---> Row
		...
		g_pl_colors.row_focus_normal = RGB(80, 80, 80);
		//---> Common.js Settings Override
		g_theme.colors.pss_back = RGB(20, 20, 20);
		g_theme.colors.panel_back = RGB(20, 20, 20);
		g_theme.colors.panel_front = RGB(20, 20, 20);
		g_theme.colors.panel_line = RGB(45, 45, 45);
		...
		//---> Common
		g_pl_colors.background = RGB(10, 115, 200);
		//---> Playlist Manager
		if (pref.autoHidePLM === true) {
		g_pl_colors.playlist_mgr_text_normal = g_pl_colors.background;
		g_pl_colors.playlist_mgr_text_hovered = RGB(230, 230, 230);
		g_pl_colors.playlist_mgr_text_pressed = RGB(255, 255, 255);
		} else {
		g_pl_colors.playlist_mgr_text_normal = RGB(220, 220, 220);
		g_pl_colors.playlist_mgr_text_hovered = RGB(255, 255, 255);
		g_pl_colors.playlist_mgr_text_pressed = RGB(220, 220, 220);
		}
		//---> Header
		g_pl_colors.group_title = RGB(220, 220, 220);
		g_pl_colors.group_title_selected = RGB(245, 245, 245);
		g_pl_colors.artist_normal = RGB(240, 240, 240);
		g_pl_colors.artist_playing = RGB(242, 230, 170);
		g_pl_colors.album_normal = RGB(230, 230, 230);
		g_pl_colors.album_playing = RGB(245, 245, 245);
		g_pl_colors.info_normal = RGB(230, 230, 230);
		g_pl_colors.info_playing = RGB(245, 245, 245);
		g_pl_colors.date_normal = RGB(240, 240, 240);
		g_pl_colors.date_playing = RGB(245, 245, 245);
		g_pl_colors.line_normal = RGB(17, 100, 182);
		g_pl_colors.line_playing = RGB(17, 100, 182);
		g_pl_colors.line_selected = RGB(17, 100, 182);
		//---> Row
		g_pl_colors.title_selected = RGB(255, 255, 255);
		g_pl_colors.title_playing = RGB(255, 255, 255);
		g_pl_colors.title_normal = RGB(230, 230, 230);
		g_pl_colors.rating_color = RGB(255, 190, 0);
		g_pl_colors.count_normal = RGB(220, 220, 220);
		g_pl_colors.count_selected = g_pl_colors.title_selected;
		g_pl_colors.count_playing = g_pl_colors.title_playing;
		...
		g_pl_colors.row_focus_normal = RGB(80, 80, 80);
		//---> Common.js Settings Override
		g_theme.colors.pss_back = RGB(10, 115, 200);
		g_theme.colors.panel_back = RGB(10, 115, 200);
		g_theme.colors.panel_front = RGB(10, 115, 200);
		g_theme.colors.panel_line = RGB(17, 100, 182);
		g_theme.colors.panel_line_selected = RGB(17, 100, 182);
		g_theme.colors.panel_text_normal = RGB(220, 220, 220);

	} else if (pref.darkblueTheme) {

		//---> Common
		g_pl_colors.background = RGB(21, 37, 56);
		//---> Playlist Manager
		if (pref.autoHidePLM === true) {
		g_pl_colors.playlist_mgr_text_normal = g_pl_colors.background;
		g_pl_colors.playlist_mgr_text_hovered = RGB(220, 220, 220);
		g_pl_colors.playlist_mgr_text_pressed = RGB(255, 255, 255);
		} else {
		g_pl_colors.playlist_mgr_text_normal = RGB(220, 220, 220);
		g_pl_colors.playlist_mgr_text_hovered = RGB(255, 255, 255);
		...
		//---> Header
		g_pl_colors.group_title = RGB(220, 220, 220);
		g_pl_colors.group_title_selected = RGB(240, 240, 240);
		g_pl_colors.artist_normal = RGB(240, 240, 240);
		g_pl_colors.artist_playing = RGB(255, 202, 128);
		g_pl_colors.album_normal = RGB(220, 220, 220);
		g_pl_colors.album_playing = RGB(245, 245, 245);
		g_pl_colors.info_normal = RGB(220, 220, 220);
		g_pl_colors.info_playing = RGB(245, 245, 245);
		g_pl_colors.date_normal = RGB(220, 220, 220);
		g_pl_colors.date_playing = RGB(245, 245, 245);
		g_pl_colors.line_normal = RGB(12, 21, 31);
		g_pl_colors.line_playing = RGB(12, 21, 31);
		g_pl_colors.line_selected = RGB(12, 21, 31);
		//---> Row
		g_pl_colors.title_selected = RGB(255, 255, 255);
		g_pl_colors.title_playing = RGB(255, 255, 255);
		g_pl_colors.title_normal = RGB(230, 230, 230);
		...
		g_pl_colors.row_focus_normal = RGB(80, 80, 80);
		//---> Common.js Settings Override
		g_theme.colors.pss_back = RGB(21, 37, 56);
		g_theme.colors.panel_back = RGB(21, 37, 56);
		g_theme.colors.panel_front = RGB(21, 37, 56);
		g_theme.colors.panel_line = RGB(12, 21, 31);
		g_theme.colors.panel_line_selected = RGB(12, 21, 31);
		g_theme.colors.panel_text_normal = RGB(220, 220, 220);

	} else if (pref.redTheme) {

		//---> Common
		g_pl_colors.background = RGB(110, 20, 20);
		//---> Playlist Manager
		if (pref.autoHidePLM === true) {
		g_pl_colors.playlist_mgr_text_normal = g_pl_colors.background;
		g_pl_colors.playlist_mgr_text_hovered = RGB(220, 220, 220);
		...
		g_pl_colors.group_title_selected = RGB(240, 240, 240);
		g_pl_colors.artist_normal = RGB(240, 240, 240);
		g_pl_colors.artist_playing = RGB(245, 212, 165);
		g_pl_colors.album_normal = RGB(220, 220, 220);
		g_pl_colors.album_playing = RGB(245, 245, 245);
		g_pl_colors.info_normal = RGB(220, 220, 220);
		g_pl_colors.info_playing = RGB(245, 245, 245);
		g_pl_colors.date_normal = RGB(220, 220, 220);
		g_pl_colors.date_playing = RGB(245, 245, 245);
		g_pl_colors.line_normal = RGB(75, 18, 18);
		g_pl_colors.line_playing = RGB(75, 18, 18);
		g_pl_colors.line_selected = RGB(75, 18, 18);
		//---> Row
		g_pl_colors.title_selected = RGB(255, 255, 255);
		g_pl_colors.title_playing = RGB(255, 255, 255);
		g_pl_colors.title_normal = RGB(220, 220, 220);
		g_pl_colors.rating_color = RGB(255, 190, 0);
		g_pl_colors.count_normal = RGB(220, 220, 220);
		g_pl_colors.count_selected = g_pl_colors.title_selected;
		g_pl_colors.count_playing = g_pl_colors.title_playing;
		...
		g_pl_colors.row_focus_normal = RGB(80, 80, 80);
		//---> Common.js Settings Override
		g_theme.colors.pss_back = RGB(110, 20, 20);
		g_theme.colors.panel_back = RGB(110, 20, 20);
		g_theme.colors.panel_front = RGB(110, 20, 20);
		g_theme.colors.panel_line = RGB(75, 18, 18);
		g_theme.colors.panel_line_selected = RGB(75, 18, 18);
		g_theme.colors.panel_text_normal = RGB(220, 220, 220);

	} else if (pref.creamTheme) {

		//---> Common
		g_pl_colors.background = RGB(255, 249, 245);
		//---> Playlist Manager
		if (pref.autoHidePLM === true) {
		g_pl_colors.playlist_mgr_text_normal = g_pl_colors.background;
		g_pl_colors.playlist_mgr_text_hovered = RGB(110, 110, 110);
		g_pl_colors.playlist_mgr_text_pressed = RGB(80, 80, 80);
		} else {
		g_pl_colors.playlist_mgr_text_normal = RGB(130, 130, 130);
		g_pl_colors.playlist_mgr_text_hovered = RGB(80, 80, 80);
		g_pl_colors.playlist_mgr_text_pressed = RGB(130, 130, 130);
		}
		//---> Header
		g_pl_colors.group_title = RGB(110, 110, 110);
		g_pl_colors.group_title_selected = g_pl_colors.group_title;
		g_pl_colors.artist_normal = RGB(100, 150, 110);
		g_pl_colors.artist_playing = RGB(255, 255, 255);
		g_pl_colors.album_normal = RGB(110, 110, 110);
		g_pl_colors.album_playing = RGB(245, 245, 245);
		g_pl_colors.info_normal = RGB(110, 110, 110);
		g_pl_colors.info_playing = RGB(245, 245, 245);
		g_pl_colors.date_normal = RGB(120, 120, 120);
		g_pl_colors.date_playing = RGB(245, 245, 245);
		g_pl_colors.line_normal = RGB(200, 200, 200);
		g_pl_colors.line_playing = RGB(220, 220, 220);
		g_pl_colors.line_selected = RGB(200, 200, 200);
		//---> Row
		g_pl_colors.title_selected = RGB(0, 0, 0);
		g_pl_colors.title_playing = RGB(245, 245, 245);
		g_pl_colors.title_normal = RGB(90, 90, 90);
		g_pl_colors.rating_color = RGB(255, 190, 0);
		g_pl_colors.count_normal = RGB(120, 122, 124);
		g_pl_colors.count_selected = g_pl_colors.title_selected;
		g_pl_colors.count_playing = g_pl_colors.title_playing;
		...
		g_pl_colors.row_focus_normal = RGB(80, 80, 80);
		//---> Common.js Settings Override
		g_theme.colors.pss_back = RGB(255, 249, 245);
		g_theme.colors.panel_back = RGB(255, 249, 245);
		g_theme.colors.panel_front = RGB(255, 249, 245);
		g_theme.colors.panel_line = RGB(200, 200, 200);
		g_theme.colors.panel_line_selected = RGB(200, 200, 200);
		g_theme.colors.panel_text_normal = RGB(110, 110, 110);

	} else if (pref.nblueTheme) {

		//---> Common
		g_pl_colors.background = RGB(12, 12, 12);
		//---> Playlist Manager
		if (pref.autoHidePLM === true) {
		g_pl_colors.playlist_mgr_text_normal = g_pl_colors.background;
		g_pl_colors.playlist_mgr_text_hovered = RGB(220, 220, 220);
		...
		g_pl_colors.playlist_mgr_text_normal = RGB(200, 200, 200);
		g_pl_colors.playlist_mgr_text_hovered = RGB(255, 255, 255);
		g_pl_colors.playlist_mgr_text_pressed = RGB(200, 200, 200);
		}
		//---> Header
		g_pl_colors.group_title = RGB(220, 220, 220);
		g_pl_colors.group_title_selected = RGB(240, 240, 240);
		g_pl_colors.artist_normal = RGB(240, 240, 240);
		g_pl_colors.artist_playing = RGB(0, 200, 255);
		g_pl_colors.album_normal = RGB(220, 220, 220);
		g_pl_colors.album_playing = RGB(240, 240, 240);
		g_pl_colors.info_normal = RGB(220, 220, 220);
		g_pl_colors.info_playing = RGB(240, 240, 240);
		g_pl_colors.date_normal = RGB(220, 220, 220);
		g_pl_colors.date_playing = RGB(0, 200, 255);
		g_pl_colors.line_normal = RGB(45, 45, 45);
		g_pl_colors.line_playing = RGB(50, 50, 50);
		g_pl_colors.line_selected = RGB(45, 45, 45);
		//---> Row
		g_pl_colors.title_selected = RGB(255, 255, 255);
		g_pl_colors.title_playing = RGB(255, 255, 255);
		g_pl_colors.title_normal = RGB(200, 200, 200);
		...
		g_pl_colors.row_focus_normal = RGB(80, 80, 80);
		//---> Common.js Settings Override
		g_theme.colors.pss_back = RGB(12, 12, 12);
		g_theme.colors.panel_back = RGB(12, 12, 12);
		g_theme.colors.panel_front = RGB(12, 12, 12);
		g_theme.colors.panel_line = RGB(45, 45, 45);
		g_theme.colors.panel_line_selected = RGB(45, 45, 45);
		g_theme.colors.panel_text_normal = RGB(220, 220, 220);
		...
		g_pl_colors.group_title_selected = RGB(240, 240, 240);
		g_pl_colors.artist_normal = RGB(240, 240, 240);
		g_pl_colors.artist_playing = RGB(0, 200, 0);
		g_pl_colors.album_normal = RGB(220, 220, 220);
		g_pl_colors.album_playing = RGB(240, 240, 240);
		g_pl_colors.info_normal = RGB(220, 220, 220);
		g_pl_colors.info_playing = RGB(240, 240, 240);
		g_pl_colors.date_normal = RGB(220, 220, 220);
		g_pl_colors.date_playing = RGB(0, 200, 0);
		g_pl_colors.line_normal = RGB(45, 45, 45);
		g_pl_colors.line_playing = RGB(50, 50, 50);
		g_pl_colors.line_selected = RGB(45, 45, 45);
		//---> Row
		...
		g_pl_colors.group_title_selected = RGB(240, 240, 240);
		g_pl_colors.artist_normal = RGB(240, 240, 240);
		g_pl_colors.artist_playing = RGB(229, 7, 44);
		g_pl_colors.album_normal = RGB(220, 220, 220);
		g_pl_colors.album_playing = RGB(240, 240, 240);
		g_pl_colors.info_normal = RGB(220, 220, 220);
		g_pl_colors.info_playing = RGB(240, 240, 240);
		g_pl_colors.date_normal = RGB(220, 220, 220);
		g_pl_colors.date_playing = RGB(229, 7, 44);
		g_pl_colors.line_normal = RGB(45, 45, 45);
		g_pl_colors.line_playing = RGB(50, 50, 50);
		g_pl_colors.line_selected = RGB(45, 45, 45);
		//---> Row
		...
		g_pl_colors.group_title_selected = RGB(240, 240, 240);
		g_pl_colors.artist_normal = RGB(240, 240, 240);
		g_pl_colors.artist_playing = RGB(254, 204, 3);
		g_pl_colors.album_normal = RGB(220, 220, 220);
		g_pl_colors.album_playing = RGB(240, 240, 240);
		g_pl_colors.info_normal = RGB(220, 220, 220);
		g_pl_colors.info_playing = RGB(240, 240, 240);
		g_pl_colors.date_normal = RGB(220, 220, 220);
		g_pl_colors.date_playing = RGB(254, 204, 3);
		g_pl_colors.line_normal = RGB(45, 45, 45);
		g_pl_colors.line_playing = RGB(50, 50, 50);
		g_pl_colors.line_selected = RGB(45, 45, 45);
		//---> Row
...
function PlaylistPanel(x, y) {
	...
	this.on_paint = function (gr) {
		...
		if (pref.layout_mode === 'default_mode') {
		gr.FillSolidRect(this.x, 0, this.w, scaleForDisplay(40), col.bg); // <- Hides also Playlist's Top 
		gr.FillSolidRect(this.x, this.y, this.w, scaleForDisplay(2), g_pl_colors.background); // <- Hides also Playlist's Top Shadow
		...
		} else if (pref.whiteTheme && pref.layout_mode === 'playlist_mode') {
		...
		} else if (pref.blackTheme && pref.layout_mode === 'playlist_mode') {
		...
		} else if (pref.blueTheme && pref.layout_mode === 'playlist_mode') {
		...
		} else if (pref.darkblueTheme && pref.layout_mode === 'playlist_mode') {
		...
		gr.FillGradRect(this.x, is_4k ? this.y - scaleForDisplay(5) : this.y - scaleForDisplay(6), this.w + 2, is_4k ? 10 : 6, 90, RGBtoRGBA(col.shadow, 0), RGBtoRGBA(col.shadow, 72)); // Playlist's Top Pseudo Shadow Fix
		gr.FillGradRect(this.x, is_4k ? this.y + this.h + 1 : this.y + this.h - 1, this.w, is_4k ? 10 : 5, 90, RGBtoRGBA(col.shadow, 74), RGBtoRGBA(col.shadow, 0)); // Playlist's Bottom Pseudo Shadow Fix
		} else if (pref.redTheme && pref.layout_mode === 'playlist_mode') {
		gr.FillGradRect(this.x, is_4k ? this.y - scaleForDisplay(10) : this.y - scaleForDisplay(23), this.w, is_4k ? 10 : 6, 90, RGBtoRGBA(col.shadow, 72), RGBtoRGBA(col.shadow, 0)); // Playlist's Top Pseudo Shadow Fix
		gr.FillGradRect(this.x, is_4k ? this.y + this.h + 1 : this.y + this.h, this.w, is_4k ? 10 : 6, 90, RGBtoRGBA(col.shadow, 72), RGBtoRGBA(col.shadow, 0)); // Playlist's Bottom Pseudo Shadow Fix
		}
		...
		gr.FillGradRect(this.x, is_4k ? this.y - scaleForDisplay(5) : this.y - scaleForDisplay(6), this.w + 2, is_4k ? 10 : 6, 90, RGBtoRGBA(col.shadow, 0), RGBtoRGBA(col.shadow, 24)); // Playlist's Top Pseudo Shadow Fix
		gr.FillGradRect(this.x, is_4k ? this.y + this.h + 1 : this.y + this.h - 1, this.w, is_4k ? 10 : 5, 90, RGBtoRGBA(col.shadow, 18), RGBtoRGBA(col.shadow, 0)); // Playlist's Bottom Pseudo Shadow Fix
		} else if (pref.creamTheme && pref.layout_mode === 'playlist_mode') {
...
class DiscHeader extends BaseHeader {
	...
	draw(gr, top, bottom) {
		...
		if (this.is_collapsed) {
			var line_y = Math.round(this.y + this.h / 2) + (is_4k ? 8 : 4);
			...
			var line_y = Math.round(this.y + this.h / 2) + (is_4k ? 8 : 4);
			if (pref.whiteTheme) {
			gr.DrawLine(is_4k ? cur_x + disc_w + 5 : cur_x + disc_w - 5, line_y, is_4k ? this.x + this.w - tracks_w - 40 : this.x + this.w - tracks_w - 10, line_y, 1, RGB(200, 200, 200));
			} else if (pref.blackTheme) {
			gr.DrawLine(is_4k ? cur_x + disc_w + 5 : cur_x + disc_w - 5, line_y, is_4k ? this.x + this.w - tracks_w - 40 : this.x + this.w - tracks_w - 10, line_y, 1, RGB(45, 45, 45));
			} else if (pref.blueTheme) {
			gr.DrawLine(is_4k ? cur_x + disc_w + 5 : cur_x + disc_w - 5, line_y, is_4k ? this.x + this.w - tracks_w - 40 : this.x + this.w - tracks_w - 10, line_y, 1, RGB(17, 100, 182));
			} else if (pref.darkblueTheme) {
			gr.DrawLine(is_4k ? cur_x + disc_w + 5 : cur_x + disc_w - 5, line_y, is_4k ? this.x + this.w - tracks_w - 40 : this.x + this.w - tracks_w - 10, line_y, 1, RGB(12, 21, 31));
			} else if (pref.redTheme) {
			gr.DrawLine(is_4k ? cur_x + disc_w + 5 : cur_x + disc_w - 5, line_y, is_4k ? this.x + this.w - tracks_w - 40 : this.x + this.w - tracks_w - 10, line_y, 1, RGB(75, 18, 18));
			} else if (pref.creamTheme) {
			gr.DrawLine(is_4k ? cur_x + disc_w + 5 : cur_x + disc_w - 5, line_y, is_4k ? this.x + this.w - tracks_w - 40 : this.x + this.w - tracks_w - 10, line_y, 1, RGB(200, 200, 200));
			} else if (pref.nblueTheme) {
			gr.DrawLine(is_4k ? cur_x + disc_w + 5 : cur_x + disc_w - 5, line_y, is_4k ? this.x + this.w - tracks_w - 40 : this.x + this.w - tracks_w - 10, line_y, 1, RGB(45, 45, 45));
	...
	draw_normal_header(gr, top, bottom) {
		...
		if (!cache_header || !this.header_image) {
			...
			if (this.is_playing()) {
				...
				const brightBackground2 = (new Color(bg_color).brightness) > 151;
				if (brightBackground2 && pref.whiteTheme && pref.layout_mode === 'playlist_mode') {
					artist_color  = rgb(80, 80, 80);
					album_color = rgb(80, 80, 80);
					info_color = rgb(80, 80, 80);
					date_color = rgb(80, 80, 80);
			...
			*/
			...
			if (this.is_playing()) {
				...
				if (pref.whiteTheme) {
					...
					if (this.hasSelection) {
						...
						grClip.FillSolidRect(scaleForDisplay(8), 0, this.w, this.h, RGB(10, 130, 220));
					} else {
						grClip.FillSolidRect(0, 0, scaleForDisplay(8), this.h, RGB(242, 230, 170));
						grClip.FillSolidRect(scaleForDisplay(8), 0, this.w, this.h, RGB(10, 130, 220));
					}
					...
					if (this.hasSelection) {
						...
						grClip.FillSolidRect(scaleForDisplay(8), 0, this.w, this.h, RGB(24, 50, 82));
					} else {
						grClip.FillSolidRect(0, 0, scaleForDisplay(8), this.h, RGB(255, 202, 128));
						grClip.FillSolidRect(scaleForDisplay(8), 0, this.w, this.h, RGB(24, 50, 82));
					}
					...
					if (this.hasSelection) {
						...
						grClip.FillSolidRect(scaleForDisplay(8), 0, this.w, this.h, RGB(130, 25, 25));
					} else {
						grClip.FillSolidRect(0, 0, scaleForDisplay(8), this.h, RGB(245, 212, 165));
						grClip.FillSolidRect(scaleForDisplay(8), 0, this.w, this.h, RGB(130, 25, 25));
					}
					...
					if (this.hasSelection) {
						grClip.FillSolidRect(0, 0, scaleForDisplay(8), this.h, RGB(0, 200, 255));
						grClip.FillSolidRect(scaleForDisplay(8), 0, this.w, this.h, RGB(25, 25, 25));
					} else {
						grClip.FillSolidRect(0, 0, scaleForDisplay(8), this.h, RGB(0, 200, 255));
						grClip.FillSolidRect(scaleForDisplay(8), 0, this.w, this.h, RGB(25, 25, 25));
					}
					...
					if (this.hasSelection) {
						grClip.FillSolidRect(0, 0, scaleForDisplay(8), this.h, RGB(0, 200, 0));
						grClip.FillSolidRect(scaleForDisplay(8), 0, this.w, this.h, RGB(25, 25, 25));
					} else {
						grClip.FillSolidRect(0, 0, scaleForDisplay(8), this.h, RGB(0, 200, 0));
						grClip.FillSolidRect(scaleForDisplay(8), 0, this.w, this.h, RGB(25, 25, 25));
					...
					if (this.hasSelection) {
						grClip.FillSolidRect(0, 0, scaleForDisplay(8), this.h, RGB(229, 7, 44));
						grClip.FillSolidRect(scaleForDisplay(8), 0, this.w, this.h, RGB(25, 25, 25));
					} else {
						grClip.FillSolidRect(0, 0, scaleForDisplay(8), this.h, RGB(229, 7, 44));
						grClip.FillSolidRect(scaleForDisplay(8), 0, this.w, this.h, RGB(25, 25, 25));
					...
					if (this.hasSelection) {
						grClip.FillSolidRect(0, 0, scaleForDisplay(8), this.h, RGB(254, 204, 3));
						grClip.FillSolidRect(scaleForDisplay(8), 0, this.w, this.h, RGB(25, 25, 25));
					} else {
						grClip.FillSolidRect(0, 0, scaleForDisplay(8), this.h, RGB(254, 204, 3));
						grClip.FillSolidRect(scaleForDisplay(8), 0, this.w, this.h, RGB(25, 25, 25));
			...
			if (g_properties.show_group_info) {
				...
				var line_x2 = this.w - (is_4k ? 40 : 20);
	...
	draw_compact_header(gr) {
		...
		*/
		...
		if (this.is_playing() && pref.whiteTheme) {
			...
			if (g_properties.use_compact_header) {
				g_pl_colors.group_title_selected = RGB(120, 120, 120);
				artist_color = album_color = date_color = g_pl_colors.group_title_selected;
			}
		...
		} else if (this.is_playing() && pref.nblueTheme || this.is_playing() && pref.ngreenTheme || this.is_playing() && pref.nredTheme || this.is_playing() && pref.ngoldTheme) {
...
class Row extends ListItem {
	...
	draw(gr) {
		...
		if (this.is_selected()) {
			if (pref.whiteTheme || pref.blackTheme) {
				if (g_properties.alternate_row_color) {
					...
					gr.DrawRect(this.x, this.y, this.w, rect_h, 1, g_pl_colors.row_focus_selected);
				}
				else {
					gr.FillSolidRect(this.x, this.y, this.w, this.h, g_pl_colors.row_selected);
				}
				gr.DrawRect(this.x, this.y, this.w, this.h, 1, g_pl_colors.row_focus_selected);
				gr.FillSolidRect(this.x, this.y, scaleForDisplay(8), this.h, col.primary);
				...
				if (g_properties.alternate_row_color) {
					// last item is cropped
					var rect_h = this.is_cropped ? this.h - 1 : this.h;
					gr.DrawRect(this.x, this.y, this.w, rect_h, 1, RGB(10, 135, 230));
				}
				else {
					gr.FillSolidRect(this.x, this.y, this.w, this.h, g_pl_colors.row_selected);
				}
				gr.DrawRect(this.x, this.y, this.w, this.h, 1, RGB(10, 135, 230));
				gr.FillSolidRect(this.x, this.y, scaleForDisplay(8), this.h, rgb(242, 230, 170));
				...
				if (g_properties.alternate_row_color) {
					// last item is cropped
					var rect_h = this.is_cropped ? this.h - 1 : this.h;
					gr.DrawRect(this.x, this.y, this.w, rect_h, 1, RGB(27, 55, 90));
				}
				else {
					gr.FillSolidRect(this.x, this.y, this.w, this.h, g_pl_colors.row_selected);
				}
				gr.DrawRect(this.x, this.y, this.w, this.h, 1, RGB(27, 55, 90));
				gr.FillSolidRect(this.x, this.y, scaleForDisplay(8), this.h, rgb(255, 202, 128));
				...
				if (g_properties.alternate_row_color) {
					// last item is cropped
					var rect_h = this.is_cropped ? this.h - 1 : this.h;
					gr.DrawRect(this.x, this.y, this.w, rect_h, 1, RGB(145, 25, 25));
				}
				else {
					gr.FillSolidRect(this.x, this.y, this.w, this.h, g_pl_colors.row_selected);
				}
				gr.DrawRect(this.x, this.y, this.w, this.h, 1, RGB(145, 25, 25));
				gr.FillSolidRect(this.x, this.y, scaleForDisplay(8), this.h, rgb(245, 212, 165));
				...
				gr.DrawRect(this.x, this.y, this.w, this.h, 1, g_pl_colors.row_focus_selected);
				gr.FillSolidRect(this.x, this.y, scaleForDisplay(8), this.h, RGB(120, 170, 130));
				...
				gr.DrawRect(this.x, this.y, this.w, this.h, 1, RGB(40, 40, 40));
				gr.FillSolidRect(this.x, this.y, scaleForDisplay(8), this.h, g_pl_colors.artist_playing);
		...
		if (this.is_playing) { // Might override 'selected' fonts
				...
				} else if (brightBackground && pref.whiteTheme && pref.layout_mode === 'playlist_mode') {
			...
			if (pref.whiteTheme || pref.blackTheme) {
				...
				gr.FillSolidRect(this.x, this.y, this.w, this.h, RGB(242, 230, 170));
				gr.FillSolidRect(this.x + scaleForDisplay(8), this.y, this.w - scaleForDisplay(8), this.h, RGB(10, 130, 220));
			} else if (pref.darkblueTheme) {
				gr.FillSolidRect(this.x, this.y, this.w, this.h, RGB(255, 202, 128));
				gr.FillSolidRect(this.x + scaleForDisplay(8), this.y, this.w - scaleForDisplay(8), this.h, RGB(24, 50, 82));
			} else if (pref.redTheme) {
				gr.FillSolidRect(this.x, this.y, this.w, this.h, RGB(245, 212, 165));
				gr.FillSolidRect(this.x + scaleForDisplay(8), this.y, this.w - scaleForDisplay(8), this.h, RGB(130, 25, 25));
			} else if (pref.creamTheme) {
				gr.FillSolidRect(this.x, this.y, this.w, this.h, RGB(120, 170, 130));
				gr.FillSolidRect(this.x + scaleForDisplay(8), this.y, this.w - scaleForDisplay(8), this.h, RGB(120, 170, 130));
			} else if (pref.nblueTheme) {
				gr.FillSolidRect(this.x, this.y, this.w, this.h, RGB(0, 200, 255));
				gr.FillSolidRect(this.x + scaleForDisplay(8), this.y, this.w - scaleForDisplay(8), this.h, RGB(25, 25, 25));
			} else if (pref.ngreenTheme) {
				gr.FillSolidRect(this.x, this.y, this.w, this.h, RGB(0, 200, 0));
				gr.FillSolidRect(this.x + scaleForDisplay(8), this.y, this.w - scaleForDisplay(8), this.h, RGB(25, 25, 25));
			} else if (pref.nredTheme) {
				gr.FillSolidRect(this.x, this.y, this.w, this.h, RGB(229, 7, 44));
				gr.FillSolidRect(this.x + scaleForDisplay(8), this.y, this.w - scaleForDisplay(8), this.h, RGB(25, 25, 25));
			} else if (pref.ngoldTheme) {
				gr.FillSolidRect(this.x, this.y, this.w, this.h, RGB(254, 204, 3));
				gr.FillSolidRect(this.x + scaleForDisplay(8), this.y, this.w - scaleForDisplay(8), this.h, RGB(25, 25, 25));
			}
		}
