...
g_properties.add_properties(
    {
        ...
        scrollbar_w:          ['user.scrollbar.width', ''],
...
class List {
    ...
    on_mouse_move(x, y, m) {
		...
		if (pref.autoSbar_Playlist === true) {
			...
			} else if ((scrollbar_hitarea_x - (is_4k ? 60 : 30) * trace_pad <= x) && (x <= scrollbar_hitarea_x - (is_4k ? 60 : 30) + scrollbar_hitarea_w + trace_pad) && 
    ...
    initialize_scrollbar() {
        ...
        // this.scrollbar = new ScrollBar(scrollbar_x, scrollbar_y, scrollbar_w, scrollbar_h, this.row_h, _.bind(this.scrollbar_redraw_callback,this));
