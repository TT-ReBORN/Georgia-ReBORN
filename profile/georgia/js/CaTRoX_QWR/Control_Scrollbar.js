...
function ScrollBar(x, y, w, h, row_h, fn_redraw) {
	this.paint = function (gr) {
		if (pref.whiteTheme) {
		gr.FillSolidRect(this.x - scaleForDisplay(8), this.y - scaleForDisplay(3), this.w + scaleForDisplay(8), this.h + scaleForDisplay(6), RGB(255, 255, 255));
		} else if (pref.blackTheme) {
		gr.FillSolidRect(this.x - scaleForDisplay(8), this.y - scaleForDisplay(3), this.w + scaleForDisplay(8), this.h + scaleForDisplay(8), RGB(20, 20, 20));
		} else if (pref.blueTheme) {
		gr.FillSolidRect(this.x - scaleForDisplay(8), this.y - scaleForDisplay(3), this.w + scaleForDisplay(8), this.h + scaleForDisplay(6), RGB(10, 115, 200));
		} else if (pref.darkblueTheme) {
		gr.FillSolidRect(this.x - scaleForDisplay(8), this.y - scaleForDisplay(3), this.w + scaleForDisplay(8), this.h + scaleForDisplay(6), RGB(21, 37, 56));
		} else if (pref.redTheme) {
		gr.FillSolidRect(this.x - scaleForDisplay(8), this.y - scaleForDisplay(3), this.w + scaleForDisplay(8), this.h + scaleForDisplay(6), RGB(110, 20, 20));
		} else if (pref.creamTheme) {
		gr.FillSolidRect(this.x - scaleForDisplay(8), this.y - scaleForDisplay(3), this.w + scaleForDisplay(8), this.h + scaleForDisplay(6), RGB(255, 249, 245));
		} else if (pref.nblueTheme || pref.ngreenTheme || pref.nredTheme || pref.ngoldTheme) {
		gr.FillSolidRect(this.x - scaleForDisplay(8), this.y - scaleForDisplay(3), this.w + scaleForDisplay(8), this.h + scaleForDisplay(6), RGB(12, 12, 12));
		}
